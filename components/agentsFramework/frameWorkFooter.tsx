                        ...
                        <div className="grid md:grid-cols-2 items-center">
                            <div className="md:text-start text-center">
                                <Link href="#" className="text-[22px] focus:outline-none">
                                    <Image height={200} width={200} src={LogoLight} className="mx-auto md:me-auto md:ms-0" alt=""/>
                                </Link>
                            </div>

                            <div>
                                <ul className="list-none footer-list md:text-end text-center mt-6 md:mt-0 space-x-1">
                                    <li className="inline"><Link href="https://github.com/codeboltai" target="_blank" className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center border border-gray-800 dark:border-slate-800 rounded-md hover:border-amber-400 dark:hover:border-amber-400 hover:bg-amber-400 dark:hover:bg-amber-400 text-slate-300 hover:text-white"><FaGithub className="h-4 w-4 align-middle"/></Link></li>
       
                                </ul>
                                <div className="mt-6 flex justify-end space-x-4">
                                    <Link href="/privacy" className="text-white hover:text-amber-400 dark:hover:text-amber-400">Privacy Policy &nbsp;</Link>|
                                    <Link href="/terms" className="text-white hover:text-amber-400 dark:hover:text-amber-400">&nbsp;Terms of Service &nbsp;</Link>|
                                    <Link href="/" className="text-white hover:text-amber-400 dark:hover:text-amber-400">&nbsp;About Us &nbsp;</Link>|
                                    <Link href="/contact" className="text-white hover:text-amber-400 dark:hover:text-amber-400">&nbsp;Contact Us</Link>
                                </div>
