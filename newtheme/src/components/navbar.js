                ...
                <div id="navigation" className={`${toggleMenu ? 'block' : ''}`}>
                    <ul className="navigation-menu">
                        ...
                        <li className="has-submenu parent-parent-menu-item">
                            ...
                            <ul className="submenu">
                                <li><Link to="/agentframework" className="sub-menu-item">CodeSquad - AI Agent Framework</Link></li>
                                <li><Link to="https://docs.codebolt.ai/" target="_blank" className="sub-menu-item">AI Agent Marketplace</Link></li>
                                <li><Link to="/agentframework" className="sub-menu-item">LogicLoom - Code Focused LLMs</Link></li>
                            </ul>
                        </li>
