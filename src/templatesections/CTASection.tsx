...
/**
 * CTASection - Call-to-action section with download button
 * 
 * A ready-to-use CTA section typically used at the end of pages.
 * 
 * @example
 * ```tsx
 * <CTASection
 *   title={"Stop optimizing for latency.\nOptimize for solution space."}
 *   description="Codebolt shifts the paradigm from speed to depth."
 *   ctaText="Download"
 *   ctaHref="/download"
 *   buildBadge="Build: 8F4A-22"
...
export function CTASection({
  ...
  return (
    <section
      className={cn(
        'relative overflow-hidden bg-background text-foreground border-t border-border dark:bg-[#050505] dark:border-neutral-900',
        className
      )}
    >
      {showOverlay && (
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-32 lg:py-48">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col items-center w-full max-w-md">
            ...
            >
              <span className="text-sm font-mono uppercase tracking-wider font-bold">{ctaText}</span>
