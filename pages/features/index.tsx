...
export default function Features() {
  ...
  return (
    <>
      <section className="relative md:py-44 py-32 bg-[url('/images/bg/bg.png')] bg-no-repeat bg-bottom bg-cover">
              ...
              <div id={`section${index}`} key={index} className="flex mt-20">
                ...
                <div className="">
                  ...
                  <div className="mt-2 bg-gradient-to-tl to-amber-400 from-fuchsia-600 rounded-lg">
                    <Image width={800} height={800} src={item.image} alt="" className="rounded-lg p-5" />
                  </div>
                </div>
              </div>
            );
