...
import {FiBookmark, FiHelpCircle, FiHexagon, FiSettings} from "react-icons/fi";
			...
			<section className="relative md:py-44 py-32 bg-[url('../../assets/images/bg/bg-pages.jpg')] bg-no-repeat bg-bottom bg-cover">
				...
				<div className="container relative">
					<div className="grid grid-cols-1 text-center mt-6">
						<div>
							<h5 className="md:text-4xl text-3xl md:leading-normal leading-normal tracking-wider font-semibold text-white mb-0">Hello !
								<br/>
							...
							return (
								<div className="text-center px-6 mt-6"
									...
									<div className="content mt-7">
										...
										<div className="mt-4">
											<Link href="" className="hover:text-amber-400">Read More
									...
									<div className="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4"
										...
										<h2 className="text-base font-semibold">
											<button type="button"
												...
												className={
													`${
														activeIndex === item.id ? "bg-gray-50 dark:bg-slate-800 text-amber-400" : ""
