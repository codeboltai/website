          ...
          <div className="grid grid-cols-1 text-center">
            <div className="">
              ...
              <p className="text-slate-400 dark:text-white/60 text-lg max-w-xl mx-auto">
                Codebolt is a next-gen Code Editor, designed with an AI
                Agents-first approach. It natively supports AI Code Generation
                Workflows and can run multiple AI agents tailored to specific
                coding language or task.
              </p>
