...
export default function RecursiveStateConvergence() {
  return (
    <section className="py-24 lg:py-32 px-6 lg:px-10 bg-background border-b border-border selection:bg-emerald-500/30 selection:text-emerald-200 dark:bg-[#030303] dark:border-zinc-800/60">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        >
          <div className="flex flex-col gap-4 mb-8">
            ...
            <h3 className="text-3xl md:text-5xl font-medium text-foreground tracking-tight leading-[1.1] dark:text-zinc-100">
          ...
          <div className="mt-8 border border-border bg-card divide-y divide-border dark:border-zinc-800 dark:bg-[#050505] dark:divide-zinc-800">
            <div className="grid grid-cols-2 divide-x divide-border dark:divide-zinc-800">
              <div className="p-4">
                <span className="block text-[9px] font-mono text-muted-foreground uppercase tracking-widest mb-1 dark:text-zinc-500">
                  Process
                </span>
                <span className="text-xs text-foreground font-mono dark:text-zinc-200">Flash_Verify Loop</span>
              </div>
              <div className="p-4">
                <span className="block text-[9px] font-mono text-muted-foreground uppercase tracking-widest mb-1 dark:text-zinc-500">
                  Pruning Rate
            ...
            <div className="p-4 bg-muted/10 dark:bg-zinc-900/10">
              <span className="block text-[9px] font-mono text-muted-foreground uppercase tracking-widest mb-1 dark:text-zinc-500">
                Outcome
              </span>
        ...
        >
          <div className="relative w-full h-[400px] flex items-center justify-center bg-card border border-border rounded-sm overflow-hidden dark:bg-[#050505] dark:border-zinc-800/60">
            <div className="absolute top-4 left-4 text-[9px] font-mono text-muted-foreground dark:text-zinc-500">
              FIG 2.1: VARIANCE REDUCTION (σ²)
            </div>
            <div className="absolute bottom-4 right-4 text-[9px] font-mono text-muted-foreground dark:text-zinc-500">
              t (inference_steps) →
            </div>
          ...
          <div className="mt-3 flex justify-between items-start px-1">
            <p className="text-[10px] text-muted-foreground font-mono max-w-md dark:text-zinc-500">
